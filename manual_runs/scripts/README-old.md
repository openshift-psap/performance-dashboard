# Manual Runs Documentation (DEPRECATED - for guidellm 0.3.x and 0.4.x)

> **NOTE:** This documentation and the associated `import_manual_run_jsons_old.py` script are for **guidellm versions 0.3.x and 0.4.x only**.
> For **guidellm 0.5.0 and above**, use `import_manual_runs_json_v2.py` and `README_v2.md` instead.

This directory contains data processing scripts for the RHAIIS Performance Dashboard.

## import_manual_run_jsons-old.py
